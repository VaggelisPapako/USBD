 ...
 */
// dia8esima blocks, mallon den ennoei ta kena pou uparxoun, alla auta pou exoun data mesa tous
 ...
 */
// sthn ousia kanei automata pin/GetBlock k uparxei hdh sth mnhmh to block -> giauto den xreiazetai h getBlock
